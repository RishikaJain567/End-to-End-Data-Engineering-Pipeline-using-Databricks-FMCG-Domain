...
# MAGIC %run 
# MAGIC /Workspace/Consolidated_Pipeline/1_setup/utilities
...
base_path = f's3://sportsbar-rd/{data_source}/*.csv'
print(base_path)
...
#F.regexp - This function searches for a text pattern and replaces it.
#syntax - F.regexp_replace(column, old_text, new_text)
...
#PROTIEN
#PrOtIeN
#All of these become: Protein
#Without (?i), only "Protien" with that exact capitalization would be replaced.
